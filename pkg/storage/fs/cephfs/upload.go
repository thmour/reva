...
func (fs *cephfs) Upload(ctx context.Context, ref *provider.Reference, r io.ReadCloser) (err error) {
...
func (fs *cephfs) AsLengthDeclarableUpload(upload tusd.Upload) tusd.LengthDeclarableUpload {
	return upload.(*fileUpload)
}
...
func (fs *cephfs) AsConcatableUpload(upload tusd.Upload) tusd.ConcatableUpload {
	return upload.(*fileUpload)
}
